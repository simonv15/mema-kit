...
function runInstall() {
  ...
  console.log('');
  console.log('Next step: Open your project in Claude Code and run /mm.onboard');
  console.log('');
  console.log('  claude');
  console.log('  > /mm.onboard');
  console.log('');
}
...
After installing, open your project in Claude Code and run /mm.onboard.
